...
export const registerNewAdmin = catchAsyncErrors(async (req, res, next) => {
    ...
    if(validateFieldsError) return next(new ErrorHandler(validateFieldsError, 400));
    ...
    if(validatePasswordError) return next(new ErrorHandler(validatePasswordError, 400));
